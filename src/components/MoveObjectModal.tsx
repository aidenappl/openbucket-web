    ...
    >
      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden">
        <div className="px-6 pt-6 pb-4">
          <h2 className="text-base font-semibold text-gray-900">Move Object</h2>
        ...
        <div className="px-6 pb-4 flex flex-col gap-3">
          <div className="flex flex-col gap-1">
            ...
            <input
              ref={inputRef}
              id="move-input"
              className="mt-1 text-sm font-mono block w-full bg-white pl-3 py-2 pr-3 rounded-lg outline-1 -outline-offset-1 outline-gray-300 focus:outline-blue-500 focus:outline-2"
              type="text"
              value={newPath}
          ...
          {formattedPath !== newPath && newPath.trim() !== "" && (
            <div className="flex flex-col gap-1">
              ...
              <span className="text-xs font-mono text-slate-600 bg-slate-50 px-3 py-2 rounded-lg border border-slate-100 break-all">
                {formattedPath}
              </span>
            </div>
          )}
